...
namespace UniFramework.Machine
{
    public class StateMachine
    {
        ...
        {
            get { return _curNode != null ? _curNode.GetType() : null; } 
        }
        ...
        public Type PreviousNodeType
        {
            get { return _preNode != null ? _preNode.GetType() : null; } 
        }
        ...
        public bool IsState<TNode>() where TNode : IStateNode
        {
            return _curNode is TNode;
        }

        public bool IsState(Type type)
        {
            return _curNode.GetType() == type;
        }
        ...
        public IStateNode TryGetNode<T>()
        {
